...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanGetSummaryViewModel()
        {
            ...
            customers.Insert(new Customer() { Id="1", Email="hackjob@gmail.com", ZipCode="90210" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("hackjob@gmail.com", "Forms"), null);
